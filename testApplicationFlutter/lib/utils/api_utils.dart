...
class ApiUtils {
  ...
  static Future<String?> getTransactionId(
    ...
    List<String>? transactionProperties,
    String? parentTransactionId,
  }) async {
    try {
      final url = '$serverUrl/transaction/start';
      final requestBody = <String, dynamic>{'moduleList': moduleList};
      if (transactionProperties != null && transactionProperties.isNotEmpty) {
        requestBody['transactionProperties'] = transactionProperties;
      }
      if (parentTransactionId != null) {
        requestBody['parentTransactionId'] = parentTransactionId;
      }
