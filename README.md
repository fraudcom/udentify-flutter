...
```bash
# Core (required)
packages/udentify-core-flutter-26.3.0814.tar.gz

# Feature plugins
packages/ocr-flutter-26.3.0814.tar.gz
packages/liveness-flutter-26.3.0814.tar.gz
packages/mrz-flutter-26.3.0814.tar.gz
packages/nfc-flutter-26.3.0814.tar.gz
packages/video-call-flutter-26.3.0814.tar.gz
```
...
```bash
tar -xzf packages/udentify-core-flutter-26.3.0814.tar.gz -C packages/
tar -xzf packages/liveness-flutter-26.3.0814.tar.gz -C packages/
# ... etc
```
