...
abstract class UdentifyCorePlatform extends PlatformInterface {
  ...
  /// the OCR camera. On Android returns the fetched property names.
  Future<List<String>?> fetchTransactionProperties(
      String serverURL, String transactionID) {
    throw UnimplementedError('fetchTransactionProperties() has not been implemented.');
  }

  /// Reset any cached transaction properties from a previous session.
  ///
  /// Should be called before starting a new transaction.
  Future<void> resetTransactionProperties() {
    throw UnimplementedError('resetTransactionProperties() has not been implemented.');
  }
  ...
  Future<void> setDeviceInfoSubPath(String? subPath) {
    throw UnimplementedError('setDeviceInfoSubPath() has not been implemented.');
  }
}
