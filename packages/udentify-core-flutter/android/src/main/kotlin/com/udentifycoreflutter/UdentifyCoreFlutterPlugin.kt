        ...
        when (call.method) {
            ...
            "setDeviceInfoSubPath" -> {
                ...
                try {
                    ...
                    android.util.Log.d("UdentifyCoreFlutterPlugin", "setDeviceInfoSubPath applied, readback: ${UdentifySettingsProvider.getDeviceInfoSubPath()}")
                    result.success(null)
                } catch (e: Exception) {
                    result.error("SET_DEVICE_INFO_SUB_PATH_ERROR", e.message, null)
                }
            }
            else -> {
