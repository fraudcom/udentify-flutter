...
abstract class LivenessFlutterPlatform extends PlatformInterface {
  ...
  /// Set callback for real-time face directive changes (FaceRecognizer interface)
  Future<void> setOnFaceDirectiveChangedCallback(
      Function(FaceDirective) callback) {
    throw UnimplementedError(
        'setOnFaceDirectiveChangedCallback() has not been implemented.');
  }

  /// Set callback for real-time active liveness directive changes
  /// (ActiveLivenessOperator interface)
  Future<void> setOnActiveLivenessDirectiveChangedCallback(
      Function(ActiveLivenessDirective) callback) {
    throw UnimplementedError(
        'setOnActiveLivenessDirectiveChangedCallback() has not been implemented.');
  }
  ...
  /// Estimate demographics (age and gender) from a base64-encoded selfie photo
  Future<DemographicsResult> estimateDemographics({
    required String serverURL,
    required String transactionID,
    required String imageBase64,
  }) {
    throw UnimplementedError('estimateDemographics() has not been implemented.');
  }
}
