...
class OcrFlutter {
  ...
  static void setOnOCRAndDocumentLivenessFailureCallback(
    ...
    MethodChannelOcrFlutter.setOnOCRAndDocumentLivenessFailureCallback(
        callback);
  }
  ...
  static Future<Map<String, dynamic>> performIQA({
  ...
  static Future<String> takePhoto() {
    return _platform.takePhoto();
  }

  static void setOnOCRDirectiveChangedCallback(Function(String, double) callback) {
    MethodChannelOcrFlutter.setOnOCRDirectiveChangedCallback(callback);
  }

  static void setOnHologramDirectiveChangedCallback(Function(String, double) callback) {
    MethodChannelOcrFlutter.setOnHologramDirectiveChangedCallback(callback);
  }

  /// Register a callback for IQA results, including the per-check map
  /// (photoCheatSatisfied, chipExistenceSatisfied, ...).
  static void setOnIQAResultCallback(Function(IQAResult) callback) {
    MethodChannelOcrFlutter.setOnIQAResultCallback(callback);
  }
