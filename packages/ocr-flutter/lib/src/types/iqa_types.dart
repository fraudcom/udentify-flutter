...
class IQAResult {
  ...
  /// Whether the image passed the quality assessment
  final bool? qualified;

  /// Individual IQA check results keyed by check name, e.g.
  /// photoCheatSatisfied, chipExistenceSatisfied, signatureExistenceSatisfied,
  /// hiddenPhotoExistenceSatisfied, facePhotoExistenceSatisfied.
  /// A check absent from the map was not evaluated for this document side.
