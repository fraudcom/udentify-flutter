...
// The LiveKitClient CocoaPod doesn't set `module_name`, so CocoaPods exposes
// it as module `LiveKitClient` (unlike LiveKit's Swift Package Manager
// distribution, which names the product `LiveKit`).
